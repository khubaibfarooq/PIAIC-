...
def function9():
    ...
    a =np.linspace(2,100,num=50, endpoint=True, retstep=False,dtype=np.int16) # write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    arr2=np.stack((arr,arr,arr),axis = 1)
    arr3=np.stack((arr,arr,arr),axis = 0)
    arr4=np.concatenate((arr2,arr3))
    
    ans =arr4.reshape(18) #write your code here 
...
def function14():
    ...
    ans = arr.array_split(arr, 4)#write your code here 
...
def function18():
    ...
    x =x=len(set(piaic)& set(students)) # Write you code Here
    return x
